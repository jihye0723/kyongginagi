...
public class ProInfo3_5 extends Fragment implements onBackPressedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter.addItem(new ProInfoItem("유보현", "031-249-9940", "byoo1@kyonggi.ac.kr"));
        adapter.addItem(new ProInfoItem("김형년", "031-249-9941","buddah@kyonggi.ac.kr"));
        adapter.addItem(new ProInfoItem("김규진", "031-249-1310","jourdan0957@gmail.com"));
        adapter.addItem(new ProInfoItem("이주향", "031-249-1310","xcelee@hanmail.net"));
        adapter.addItem(new ProInfoItem("신창현", "031-249-1386","shinch@kyonggi.ac.kr"));
    ...
    private void goToMain(){
        ...
        fragmentManager.beginTransaction().remove(ProInfo3_5.this).commit();
