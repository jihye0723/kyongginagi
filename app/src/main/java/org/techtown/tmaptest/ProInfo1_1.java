...
public class ProInfo1_1 extends Fragment implements onBackPressedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        proTitle.setText("교직학부");

        proInfo_content=view.findViewById(R.id.proInfo_content);
        ProInfoAdapter adapter= new ProInfoAdapter();

        adapter.addItem(new ProInfoItem("최항석", "031-249-9188", "hangchoi@kyonggi.ac.kr"));
        adapter.addItem(new ProInfoItem("하봉운", "031-249-9192", "bha@kgu.ac.kr"));
        adapter.addItem(new ProInfoItem("김 철", "031-249-9183", "kcpms84@kgu.ac.kr"));
        adapter.addItem(new ProInfoItem("장경원", "031-249-9184", "kyungwon@kgu.ac.kr"));
        adapter.addItem(new ProInfoItem("박수원", "031-249-9157", "swpark1@kyonggi.ac.kr"));
    ...
    private void goToMain(){
        ...
        fragmentManager.beginTransaction().remove(ProInfo1_1.this).commit();
