...
public class ProInfo5_3 extends Fragment implements onBackPressedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        proTitle.setText("경영정보전공");

        proInfo_content=view.findViewById(R.id.proInfo_content);
        ProInfoAdapter adapter= new ProInfoAdapter();

        adapter.addItem(new ProInfoItem("주석진", "031-249-9456", "sjju@kyonggi.ac.kr"));
        adapter.addItem(new ProInfoItem("김중한", "031-249-9458", "jhkim@kgu.ac.kr"));
        adapter.addItem(new ProInfoItem("박상언", "031-249-9459", "supark@kgu.ac.kr"));
        adapter.addItem(new ProInfoItem("성태경", "031-249-9457", "tksung@kgu.ac.kr"));
        adapter.addItem(new ProInfoItem("홍준석", "031-249-9454", "junehong@kyonggi.ac.kr"));
        adapter.addItem(new ProInfoItem("서일정", "031-249-1521", "ijseo@kgu.ac.kr"));
    ...
    private void goToMain(){
        ...
        fragmentManager.beginTransaction().remove(ProInfo5_3.this).commit();
