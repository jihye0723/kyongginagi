...
public class ProInfo1_3 extends Fragment implements onBackPressedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        proTitle.setText("진성애교양교육연구센터");

        proInfo_content=view.findViewById(R.id.proInfo_content);
        ProInfoAdapter adapter= new ProInfoAdapter();

        adapter.addItem(new ProInfoItem("박영우","031-249-9124","rainbk@hanmail.net"));
        adapter.addItem(new ProInfoItem("박종은","031-249-9067","parkje@kgu.ac.kr"));
        adapter.addItem(new ProInfoItem("김은유","031-249-9497","dmsb0110@kyonggi.ac.kr"));
        adapter.addItem(new ProInfoItem("손한결","031-249-9088","hgson00@kgu.ac.kr"));
    ...
    private void goToMain(){
        ...
        fragmentManager.beginTransaction().remove(ProInfo1_3.this).commit();
