...
public class ProInfo1_4 extends Fragment implements onBackPressedListener {
    ...
    private void goToMain(){
        ...
        fragmentManager.beginTransaction().remove(ProInfo1_4.this).commit();
