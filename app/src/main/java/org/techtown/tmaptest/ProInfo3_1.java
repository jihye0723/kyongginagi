...
public class ProInfo3_1 extends Fragment implements onBackPressedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter.addItem(new ProInfoItem("양덕환", "031-249-9939","potter-y@hanmail.com"));
        adapter.addItem(new ProInfoItem("안필연", "031-249-9920","pyahn4@naver.com"));
        adapter.addItem(new ProInfoItem("최기석", "031-249-9918","62kiki@hanmail.net"));
        adapter.addItem(new ProInfoItem("박광일", "031-249-9919","artpki@naver.com"));
        adapter.addItem(new ProInfoItem("서영기", "031-249-9921","syg19970070@hanmail.com"));
    ...
    private void goToMain(){
        ...
        fragmentManager.beginTransaction().remove(ProInfo3_1.this).commit();
