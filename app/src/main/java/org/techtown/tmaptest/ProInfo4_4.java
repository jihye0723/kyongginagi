...
public class ProInfo4_4 extends Fragment implements onBackPressedListener {
    ...
    private void goToMain(){
        ...
        fragmentManager.beginTransaction().remove(ProInfo4_4.this).commit();
