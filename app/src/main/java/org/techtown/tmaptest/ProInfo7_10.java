...
public class ProInfo7_10 extends Fragment implements onBackPressedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter.addItem(new ProInfoItem("강현철", "031-249-9514", "tanny@kyonggi.ac.kr"));
        adapter.addItem(new ProInfoItem("최용화", "031-249-1377", "cyhwa0724@hanmail.net"));
    ...
    private void goToMain(){
        ...
        fragmentManager.beginTransaction().remove(ProInfo7_10.this).commit();
